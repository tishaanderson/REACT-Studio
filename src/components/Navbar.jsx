        ...
        {[
          {
            text: "LinkedIn",
            icon: <LinkedInIcon />,
            link: "https://www.linkedin.com/in/tisha-anderson/",
          },
          {
            text: "Github",
            icon: <GitHubIcon />,
            link: "https://github.com/tishaanderson",
          },
          {
            text: "Instagram",
            icon: <InstagramIcon />,
            link: "https://www.instagram.com/curlyqtish/",
          },
        ].map((item, index) => (
          <ListItem key={index} disablePadding component={Link} to={item.link}>
            <ListItemButton>
      ...
      {["right"].map((anchor) => (
        <React.Fragment key={anchor}>
          <Button
            ...
            startIcon={<MenuIcon style={{ color: "16275b" }} />}
          ></Button>
          <Drawer
            anchor={anchor}
            open={state[anchor]}
